...
export const projects = [
  {
    ...
    desc: "School management platform with student enrollment, attendance tracking, grade management, parent portal, and real-time notifications. Handles 500+ students with role-based access.",
  ...
  },
  {
    ...
    desc: "Hospital management with patient records, appointment scheduling, billing, pharmacy integration, lab reports, and doctor dashboards. HIPAA-compliant data handling.",
  ...
  },
  {
    ...
    desc: "Hotel operations platform with room booking, guest management, housekeeping tracking, billing, and revenue analytics. Multi-property support with centralized control.",
  ...
  },
  {
    ...
    desc: "Digital transformation solution for government sectors with citizen services, document management, payment processing, and secure data handling. Multi-language support.",
...
export const testimonials = [
  {
    ...
    text: "Amenti delivered a school management system for our institution. The system handles 1000+ students seamlessly with real-time notifications. Our administrative workload decreased by 60%.",
    avatar: "AT",
  },
  {
    id: 2,
    ...
    text: "The hospital management system Amenti built transformed our operations. Patient records, appointments, and billing are now fully integrated. The system is secure, reliable, and HIPAA-compliant.",
    avatar: "HA",
  },
  {
    id: 3,
    ...
    text: "Amenti's delivery tracking system with GPS integration is exactly what we needed. Real-time tracking, driver management, and customer notifications work flawlessly. Highly recommended!",
    avatar: "YK",
  },
];
